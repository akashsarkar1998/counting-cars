...
def count_cars(video_path):
    ...
    frame_counter = 0
    frame_skip = 5  # Adjust the number of frames to skip
    ...
    while True:
        ...
        for out in outs:
            for detection in out:
                ...
                if class_id == car_class_id and confidence > 0.1:  # Adjust the confidence threshold
                    # Draw detection box
        ...
        # Print car count in the terminal
